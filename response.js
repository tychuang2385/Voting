let fs = require("fs"),
  ...
  adminQuestionnaireListPagePath =
    __dirname + "/web/html/AdminQuestionnaireList.ejs",
  ...
  adminQuestionnaireListPage = fs.readFileSync(
    adminQuestionnaireListPagePath,
    "utf8"
  ),
...
Response.prototype = {
  ...
  getAdminQuestionnaireListPage: function (res, qnList, QusetionnaireID_def) {
    res.writeHead(200, { "Content-Type": "text/html" });
    res.end(
      ejs.render(adminQuestionnaireListPage, {
        qnList: qnList,
        QusetionnaireID_def: QusetionnaireID_def,
      })
    );
  },
